...
namespace PokeD.Server.Storage.Files
{
    public class ModuleSCONConfigFile : BaseFile, IConfigFile
    {
        ...
        public ModuleSCONConfigFile(ConfigType configType) : base(new ConfigFolder().CreateFile($"ModuleSCON{configType.GetFileExtension()}", CreationCollisionOption.OpenIfExists)) { ConfigType = configType; }
    }
}